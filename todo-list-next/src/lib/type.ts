...
export interface paths {
  "/todolists": {
    get: operations["get/todolists"];
    post: operations["post/todolists"];
  };
  "/todolists/{id}": {
    get: operations["get/todolists/{id}"];
    put: operations["put/todolists/{id}"];
    delete: operations["delete/todolists/{id}"];
  };
  "/upload": {
...
export interface components {
  schemas: {
    ...
    TodolistListResponseDataItem: {
      id?: number;
      attributes?: components["schemas"]["Todolist"];
    };
    TodolistListResponse: {
      data?: components["schemas"]["TodolistListResponseDataItem"][];
      meta?: {
        pagination?: {
          page?: number;
          pageSize?: number;
    ...
    TodolistResponseDataObject: {
      id?: number;
      attributes?: components["schemas"]["Todolist"];
    };
    TodolistResponse: {
      data?: components["schemas"]["TodolistResponseDataObject"];
...
export interface operations {
  ...
  "get/todolists": {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": components["schemas"]["TodolistListResponse"];
        };
      };
  ...
  "post/todolists": {
    requestBody: {
      content: {
        "application/json": components["schemas"]["TodolistRequest"];
      };
    };
    responses: {
      /** @description OK */
